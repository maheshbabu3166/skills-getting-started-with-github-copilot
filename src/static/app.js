    ...
    try {
      ...
      const participantsHtml = details.participants.length
        ? `<ul class="participant-list">${details.participants
            .map((participant) => `<li class="participant-item"><span class="participant-email">${participant}</span><button class="participant-remove" data-email="${participant}">🗑️</button></li>`)
            .join("")}</ul>`
